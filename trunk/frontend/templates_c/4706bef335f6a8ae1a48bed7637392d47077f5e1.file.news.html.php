<?php /* Smarty version Smarty-3.1.16, created on 2014-03-31 18:33:24
...
<?php if ($_valid && !is_callable('content_532ab1f0cd5991_38995183')) {function content_532ab1f0cd5991_38995183($_smarty_tpl) {?><table class="partie" align="center">
    ...
    <tr>
        <th>
            <form method="post" action="index.php?page=news&v1=research_news">
                <input type="text" autocomplete="off" name="v2" id="champ_recherche" />
